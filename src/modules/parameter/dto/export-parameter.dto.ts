...
/**
 * Payload export Excel Parameter (background job).
 *
 ...
 * sedang tampil.
 */
export const ExportParameterSchema = z.object({
...
export type ExportParameterDto = z.infer<typeof ExportParameterSchema>;
