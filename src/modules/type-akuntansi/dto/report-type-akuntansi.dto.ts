...
/**
 * Payload cetak laporan Type Akuntansi.
 *
 ...
 */
export const ReportTypeAkuntansiSchema = z.object({
...
export type ReportTypeAkuntansiDto = z.infer<typeof ReportTypeAkuntansiSchema>;
