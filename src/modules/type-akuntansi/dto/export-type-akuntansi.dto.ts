...
/**
 * Payload export Excel Type Akuntansi (background job).
 *
 ...
 * sedang tampil.
 */
export const ExportTypeAkuntansiSchema = z.object({
...
export type ExportTypeAkuntansiDto = z.infer<typeof ExportTypeAkuntansiSchema>;
