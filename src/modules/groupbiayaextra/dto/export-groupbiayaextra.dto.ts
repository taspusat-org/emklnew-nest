...
/**
 * Payload export Excel Group Biaya Extra (background job).
 *
 ...
 * sedang tampil.
 */
export const ExportGroupbiayaextraSchema = z.object({
...
export type ExportGroupbiayaextraDto = z.infer<
  typeof ExportGroupbiayaextraSchema
>;
