...
/**
 * Payload export Excel Shipping Instruction (background job).
 *
 ...
 * sedang tampil.
 */
export const ExportShippingInstructionSchema = z.object({
...
export type ExportShippingInstructionDto = z.infer<
  typeof ExportShippingInstructionSchema
>;
